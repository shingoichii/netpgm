...
serverと同じコンピュータ上で動かす際には`localhost`のままで良いですが、別のコンピュータと通信してみる際にはここに相手のIPアドレスを"192.168.1.151"のように入れてください。
...
これは、あらかじめ相手を認証しておいたり、通信路を暗号化したりしていない場合、危険な行為です。
